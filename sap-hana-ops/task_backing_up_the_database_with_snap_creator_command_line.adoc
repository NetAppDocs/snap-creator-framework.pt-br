...
summary: Você também pode fazer backup do banco de dados usando a linha de comando Snap Creator. 
---
= Fazer backup do banco de dados com a linha de comando Snap Creator
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você também pode fazer backup do banco de dados usando a linha de comando Snap Creator.

. Para fazer backup do banco de dados, execute o seguinte comando.
+
[listing]
----

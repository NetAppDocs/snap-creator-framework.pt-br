...
Running
----
. Valide a inicialização da interface de usuário do Snap Creator Framework navegando até o host local na porta especificada (por exemplo,  https://10.12.123.123:8443)+[].
+

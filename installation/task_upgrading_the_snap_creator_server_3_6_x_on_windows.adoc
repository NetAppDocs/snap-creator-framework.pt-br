...
Além disso, você deve validar a inicialização da interface de usuário do Snap Creator Framework navegando até o host local na porta especificada +(https://IP_address:gui_port)+[].

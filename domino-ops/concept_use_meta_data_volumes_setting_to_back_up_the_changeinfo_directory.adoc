...
Você já deve ter identificado o volume changeinfo como um volume a ser copiado quando criou o arquivo de configuração. Para obter mais informações, consulte a etapa link:task_using_the_gui_to_create_a_configuration_file.html["tarefa usando a gui para criar uma configuração"].

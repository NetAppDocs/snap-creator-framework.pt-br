...
NOTE: Você pode forçar o plug-in a prosseguir com as operações de backup apesar dos erros, conforme descrito na etapa link:task_using_the_gui_to_create_a_configuration_file.html["tarefa_usando_a_interface_de_usuário_para_criar_um_arquivo_de_configuração"].

...
. [[thirteenth-step]]Na página de detalhes do Snapshot, especifique as informações de configuração do Snapshot:
+
|===
| Para este campo... | Faça isso... 
...
.. As instruções estão na próxima etapa<<thirteenth-step,13>>.

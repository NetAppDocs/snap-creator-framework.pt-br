...
NTAP_OSSV_FS_SNAPSHOT_CREATE_CMD
 a| 
 a| 
Execute estes scripts ou comandos durante ou antes do processo de backup do OSSV, onde ## é um número de 01 a 99. Isso pode ser usado para realizar backups de snapshots do sistema de arquivos usando o OSSV.

...
(S|N)
 a| 
Permite que o endereço IP seja usado para o sistema de armazenamento. Isso se aplica ao SnapVault, ao SnapMirror e ao recurso de proteção de dados do Console de Gerenciamento da NetApp . O uso de endereços IP pode causar problemas e só deve ser feito em determinadas condições.
